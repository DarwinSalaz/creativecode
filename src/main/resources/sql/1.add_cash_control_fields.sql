...
ALTER TABLE cash_movements ADD COLUMN IF NOT EXISTS down_payments DOUBLE PRECISION;
ALTER TABLE cash_movements ADD COLUMN IF NOT EXISTS service_id BIGINT;
ALTER TABLE cash_movements ADD COLUMN IF NOT EXISTS wallet_id INTEGER;
ALTER TABLE cash_movements ADD CONSTRAINT fk_cm_wallet FOREIGN KEY (wallet_id) REFERENCES wallets (wallet_id);
ALTER TABLE services ADD COLUMN IF NOT EXISTS has_expired_payment BOOLEAN;
ALTER TABLE services ADD COLUMN IF NOT EXISTS pending_value DOUBLE PRECISION;
ALTER TABLE service_products ADD COLUMN IF NOT EXISTS enabled BOOLEAN;
